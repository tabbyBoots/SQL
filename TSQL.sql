...
SET @sqlcommand = N'SELECT Product.ProductNo, Product.ProductName, Product.ProductSpec, Product.VendorNo, Vendor.ShortName FROM Product LEFT OUTER JOIN Vendor ON Product.VendorNo = Vendor.VendorNo;' 
